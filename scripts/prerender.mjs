...
const PAGE_FAQS = {
  ...
  '/team-statistics': [
    { question: 'What is Team Statistics?', answer: 'Team Statistics is a Team Synergy page that combines player leaderboard categories, all-time SHOTM points standings, and common shiny Pokemon trends.' },
    { question: 'How are player leaderboard categories ranked?', answer: 'Each category is ranked using Team Synergy shiny data, and the page shows the top 3 players for each category.' },
    { question: 'What does the all-time leaderboard show?', answer: 'The all-time leaderboard shows total SHOTM points per player using tier-based shiny scoring across all recorded catches.' },
    { question: 'What does most common Pokemon mean?', answer: 'Most common Pokemon lists the top 5 shiny species with the highest total catch count across the full Team Synergy dataset.' },
  ],
  '/pokedex': [
  ...
  '/sprite-recolour': [
    ...
    { question: 'Can I upload my own GIFs?', answer: 'Yes, the tool supports uploading your own GIFs and images in addition to the built-in Pokemon library.' },
    { question: 'How do I change a specific colour?', answer: 'Hover over the preview to pause the animation, click the colour you want on the sprite, and the matching palette editor will open for that colour.' },
    { question: 'What can I export after editing?', answer: 'You can export the current frame as a PNG or export the recoloured animation as a GIF.' },
  ],
...
async function prerenderRoute(templateHtml, outPath, meta = {}) {
  ...
  function getHiddenSeoContent(route, meta = {}) {
    const pageDescriptions = {
      ...
      '/team-statistics': `<h1 class="seo-semantic-hidden">Team Statistics - Team Synergy Leaderboards</h1><section class="seo-semantic-hidden"><p>Team Statistics is Team Synergy's central leaderboard hub for PokeMMO shiny hunting performance. Compare top players across luck, dry streaks, rare catches, phase records, and weekly shiny totals with top 3 rankings in every category. Track the all-time SHOTM points leaderboard to see which members have the strongest long-term scoring history. Analyze shiny trends through our most common Pokemon ranking to discover the most frequently caught species in the community.</p></section>`,
      '/route-finder': `<h1 class="seo-semantic-hidden">Route Finder - PokeMMO Encounter Percentages</h1><section class="seo-semantic-hidden"><p>Route Finder searches tracked PokeMMO encounter percentage data by Pokemon or route. Use it to find target Pokemon, compare route percentages, and identify phase Pokemon on each tracked route.</p></section>`,
      ...
      "/sprite-recolour": "<h1 class=\"seo-semantic-hidden\">PokeMMO Sprite Recolour Gallery - Custom Pokemon Sprites</h1><section class=\"seo-semantic-hidden\"><p>Explore a gallery of custom sprite recolours for PokeMMO featuring fan-made designs and creative takes on classic Pokemon. Our sprite recolour collection includes unique color variations, shiny-inspired designs, and artistic reinterpretations of popular Pokemon. Browse through hundreds of custom sprites to find new favorites and get inspired for your own recolour projects. Team Synergy's sprite recolour gallery celebrates the creativity of the PokeMMO community and provides a platform for sharing custom sprite art. Whether you're looking for a fresh take on your favorite Pokemon or seeking inspiration for your own recolours, our gallery has something for every fan.</p></section>"
    };
...
async function prerender() {
  ...
  const STATIC_META = {
    ...
    '/player-card-generator': {
      ...
      ogTitle: 'PokeMMO Player Card Generator | Team Synergy',
      ogDescription: 'Upload your encounter tracker JSON and trainer image to create a downloadable PokeMMO player card with encounter totals, shinies, rares seen, and most seen Pokemon.',
      ogImage: 'https://synergymmo.com/images/openGraph.jpg',
      crawlerLinks: pokemonLinks,
    },
    '/official-event-calendar': {
    ...
    '/route-finder': {
      route: '/route-finder',
      ogTitle: 'Route Finder | Team Synergy - PokeMMO',
      ogDescription: 'Search tracked PokeMMO encounter percentages by Pokemon or route. Find target Pokemon, shiny hunt phases, route totals, and credited route data.',
      ogImage: 'https://synergymmo.com/images/openGraph.jpg',
    },
    '/events': {
      route: '/events',
